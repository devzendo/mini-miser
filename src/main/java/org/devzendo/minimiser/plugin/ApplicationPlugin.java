...
public interface ApplicationPlugin extends Plugin {
     ...
     * or Apache License v2 2009 The FrooBar project
     *
     ...
     * indicate this.
     *
     * If you use the Apache License v2, you may use the framework's
     * copy of this text by returning "LICENSE.txt" here.
     *
     * e.g. META-INF/minimiser/myapp/BSDLicense.html
     *
     * @return a resource path
     */
