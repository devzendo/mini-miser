 ...
 *
 */
public final class StubMessageQueueMiniMiserPrefs implements MiniMiserPrefs {
    private static final Logger LOGGER = Logger.getLogger(StubMessageQueueMiniMiserPrefs.class);
